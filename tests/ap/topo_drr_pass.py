...
class FakeDataForYieldAccessTopoPass(access_topo_drr.DrrPass):
  ...
  def source_pattern(self, o, t):
    ...
    o.yield_op(
      map(get_yield_input, range(self.num_outputs)),
      []
    )
  ...
  def result_pattern_data_op(self, o, t):
    map(lambda i: self.data_op_for_output(o, t, i), range(self.num_outputs))
  ...
  def result_pattern_up_spider(self, o, t):
    map(lambda i: self.up_spider_for_output(o, t, i), range(self.num_outputs))
...
class FakeDataStoreToGlobalForYieldAccessTopoPass(access_topo_drr.DrrPass):
  ...
  def result_pattern_store_to_global_op(self, o, t):
    map(lambda i: self.store_to_global_op_for_output(o, t, i), range(self.num_outputs))
  ...
  def store_to_global_op_for_output(self, o, t, i):
    ...
    store_to_global_op.index_func_unique_id = lambda o, t: pir.a_str(self.fake_data_names[i])
    store_to_global_op(
...
class InitNaiveLoadFromGlobalAccessTopoPass(access_topo_drr.DrrPass):
  ...
  def result_pattern(self, o, t):
    ...
    o.load_from_global.index_func_unique_id = lambda o, t: self.data_input_name_attr
    o.load_from_global(
      [t.input],
      [t.output]
    )
...
class ReplaceWithLoadFromRegisterPass(access_topo_drr.DrrPass):
  ...
  def result_pattern(self, o, t):
    ...
    o.load_from_register.register_var_name = lambda o, t: self.register_var_name
    o.load_from_register.type = lambda o, t: pir.a_type(t.output.type)
    o.load_from_register.symbolic_shape_or_data = (
      lambda o, t: pir.a_symbol(t.output.get_symbolic_shape_or_data())
    )
    o.load_from_register(
      [],
      [t.output]
    )
...
class ReplaceWithStoreToRegisterPass(access_topo_drr.DrrPass):
  ...
  def source_pattern(self, o, t):
    ...
    o.store_to_global_op(
      [t.output, t.output_val],
      []
    )
  ...
  def result_pattern(self, o, t):
    ...
    o.store_to_register_op.register_var_name = lambda o, t: self.register_var_name
    o.store_to_register_op(
      [t.output_val],
      []
    )
...
@access_topo_drr.register_drr_pass("down_spider_load_from_global", tag="default")
