...
template <
  ...
  /// Epilogue output operator      - must satisfy concept of 'EpilogueWithVariadicOp'
...
struct DefaultGemmWithVariadic {
  ...
  // Define epilogue
  using Epilogue = typename cutlass::epilogue::threadblock::DefaultEpilogueWithVariadicTensorOp<
...
struct DefaultGemmWithVariadic<
  ...
  // Define epilogue
  using Epilogue = typename cutlass::epilogue::threadblock::DefaultEpilogueWithVariadicVoltaTensorOp<
    typename GemmBase::Epilogue::Shape,
    typename GemmBase::Epilogue::WarpMmaOperator,
    GemmBase::Epilogue::kPartitionsK,
    ElementC_,
