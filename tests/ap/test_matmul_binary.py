...
class MatmulBinaryFusion(abstract_drr.DrrPass):
    def source_pattern(self, o, t):
        ...
        o.trivial_op([t.output0, t.input2], [t.output1])
    ...
    def result_pattern(self, o, t):
        ...
        o.fustion_op([t.input0, t.input1, t.input2], [t.output1])
...
def CodeGen(ctx, o, t):
    trivial_op_code_gen_class = ctx.make_fusion_op_code_gen_class(
        o.trivial_op,
        input_index_loop_anchor_flags=[False, False],
    ...
    dtypes = [t.input0.dtype, t.input1.dtype, t.input2.dtype, t.output1.dtype]
